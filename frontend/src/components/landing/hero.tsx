...
const HeroLeft = () => {
  ...
  return (
    <div className="w-full bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 flex flex-col" role="region" aria-label="LinkedIn message example">
      {/* Header */}
      <div className="py-3 px-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative">
              <div className="h-12 w-12 rounded-full overflow-hidden">
                <Image src="/emma.avif" width={60} height={60} alt="Emma Thompson profile" />
              </div>
              <div className="absolute bottom-1 right-0 w-2.5 h-2.5 bg-green-400 rounded-full border border-white" aria-label="Online status" role="status"></div>
            </div>
            <div>
          ...
          <div className="flex items-center gap-2">
            <button className="p-1.5 hover:bg-white/10 rounded-full transition-colors" aria-label="Star conversation">
              <Star className="w-4 h-4" aria-hidden="true" />
            </button>
            <button className="p-1.5 hover:bg-white/10 rounded-full transition-colors" aria-label="More options">
      ...
      <div className="px-4 py-10 border-gray-100 flex-grow">
        <div className="flex items-start gap-3">
          <div className="h-8 w-8 rounded-full overflow-hidden flex-shrink-0">
            <Image src="/emma.avif" width={50} height={50} alt="Emma Thompson" />
          </div>
      ...
      <div className="p-4 border-t mt-20 border-gray-100">
        ...
        <div className="flex gap-2 mb-3" role="tablist">
          <button
            ...
            aria-controls="without-scrive-panel"
            id="without-scrive-tab"
          >
            <span>Without Scrive</span>
            {step === 0 && <AlertCircle className="w-4 h-4" aria-hidden="true" />}
          </button>
          <button
            className={`py-1.5 px-3 rounded-full text-sm font-medium flex items-center gap-1.5 ${
              step === 1
            ...
            aria-controls="with-scrive-panel"
            id="with-scrive-tab"
          >
            <span>With Scrive</span>
            {step === 1 && <CheckCircle2 className="w-4 h-4" aria-hidden="true" />}
          </button>
        </div>
        ...
        <div 
          ...
          role="tabpanel"
          id={step === 0 ? "without-scrive-panel" : "with-scrive-panel"}
          aria-labelledby={step === 0 ? "without-scrive-tab" : "with-scrive-tab"}
        >
          <div className="p-3 relative">
            <textarea
              ...
              readOnly
              aria-label="Message response area"
            ></textarea>
          </div>
          ...
          <div className="px-3 py-2.5 flex items-center justify-between border-t border-gray-100 bg-gray-50">
            <div className="flex items-center gap-2">
              <button className="p-1.5 hover:bg-gray-200 rounded-md transition-colors" aria-label="Add image">
                <ImageIcon className="w-5 h-5 text-gray-500" aria-hidden="true" />
              </button>
              <button className="p-1.5 hover:bg-gray-200 rounded-md transition-colors" aria-label="Add link">
                <LinkIcon className="w-5 h-5 text-gray-500" aria-hidden="true" />
              </button>
              <button className="p-1.5 hover:bg-gray-200 rounded-md transition-colors" aria-label="Add emoji">
                <SmilePlus className="w-5 h-5 text-gray-500" aria-hidden="true" />
              </button>
            </div>
